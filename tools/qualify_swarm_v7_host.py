...
def contract_probes(h: Harness) -> None:
    ...
    verify="gh api --method GET --paginate repos/owner/repo/issues/1/comments --jq \'.[] | select(.body | contains(\"<!-- hermes-swarm-adjudication:s:1:1111111111111111111111111111111111111111 -->\")) | .body\' | grep -o \'hermes-swarm-decision-b64:[A-Za-z0-9_=-]*\' | cut -d: -f2- | tr \'_-\' \'/+\' | base64 -d | jq -e ."
