...
class SwarmV7CliQualityTests(unittest.TestCase):
    def test_owned_boundary_is_active_and_consolidated(self):
        ...
        self.assertLessEqual(quality.code_loc((quality.SCRIPTS/"swarm_v7_cli.py").read_text(encoding="utf-8")),160)
        self.assertLessEqual(quality.code_loc((quality.SCRIPTS/"swarm_v7_cli_process.py").read_text(encoding="utf-8")),30)
